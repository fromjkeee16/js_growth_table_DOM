/* eslint-disable prefer-const */ /* eslint-disable no-console */ /* eslint-disable no-unused-vars */ "use strict";
const MAX_ROWS = 10;
const MAX_COLS = 10;
const MIN_ROWS = 2;
const MIN_COLS = 2;
...
function addRow() {
    if (currentNumRows >= MAX_ROWS) return;
...
function addCol() {
    if (currentNumCols >= MAX_COLS) return;
...
function removeCol() {
    const lastColCells = [
        ...field.rows
    ].map((row)=>row.cells[currentNumCols - 1]);
